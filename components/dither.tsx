...
void main() {
  ...
  // Calculate alpha based on pattern intensity or just use a fixed alpha
  // Using pattern 'f' to modulate alpha can create a nice effect where 'waves' are more opaque
  float alpha = smoothstep(0.0, 1.0, f) * 0.5; // Adjust 0.5 to control overall opacity
